...
function sparqlToDataTable(sparql, element, options = {}) {
    ...
    var linkPrefixes = (typeof options.linkPrefixes === 'undefined') ? {}
     : options.linkPrefixes;
    var linkParams = (typeof options.linkParams === 'undefined') ? {}
     : options.linkParams;
    ...
    var sepcharmap = (typeof options.sepcharmap === 'undefined') ? {}
     : options.sepcharmap;
    if (pBar != "") {
        $('#' + pBar).progressbar({
            value: false
	...
	if (usepropertyMapping) {
		propertyMapping = {
			...
			"P625": {
				"label": "predominant gender usage",
				"replacement": ""
			},
			"P1853": {
				"label": "time frame",
			...
			"P131": {
				"label": "Resarch projects that contributed to this dataset",
				"replacement": ""
			},
			"P8": {
				"label": "part of",
